...
class BVContext:
    ...
    def __init__(self, handle: AdapterHandle, params: Dict[str, str]):
        self.handle = handle
        self.params = params
        self.stmts = {}
        self.portals = {}
    ...
    def process_id(self):
        return self.handle.process_id

    def secret_key(self):
        return self.handle.secret_key
...
class BuenaVistaHandler(socketserver.StreamRequestHandler):
    ...
    def handle_startup(self, adapter: Adapter) -> BVContext:
        ...
        if code == 80877103:  ## SSL request
            ...
            self.send_parameter_status(adapter.parameters())
